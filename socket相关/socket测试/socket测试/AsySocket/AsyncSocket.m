...
- (NSData *)connectedAddress
{
    ...
    if (theSocket)
    {
		...
		NSData *result = [(__bridge_transfer NSData *)peeraddr autorelease];
...
- (NSData *)localAddress
{
    ...
    if (theSocket)
    {
		...
		NSData *result = [(__bridge_transfer NSData *)selfaddr autorelease];
		return result;
	}
...
- (NSString *)description
{
	...
	NSMutableString *ms = [[[NSMutableString alloc] initWithCapacity:150] autorelease];
...
static void MyCFSocketCallback (CFSocketRef sref, CFSocketCallBackType type, CFDataRef inAddress, const void *pData, void *pInfo)
{
	@autoreleasepool {
		...
		NSData *address = [[(__bridge NSData *)inAddress copy] autorelease];
